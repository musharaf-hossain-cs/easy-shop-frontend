<template>
  <div v-if="loaded">
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6">
        <b-form>
          <h5>Current Name: <b>{{employee.FIRST_NAME + ' ' +employee.LAST_NAME}}</b></h5>
          <b-form-group
              label="New Name:"
              label-for="newName"
          >
          ...
          <hr>
          <h5>Current Email: <b>{{employee.EMAIL}}</b></h5>
          <b-form-group
              id="form-group-email"
              label-for="newEmail"
              label="New Email: "
          ...
          <hr>
          <h5>Current Mobile: <b>{{employee.MOBILE}}</b></h5>
          <b-form-group
              label="New Mobile:"
              label-for="newMobile"
          >
          ...
          <h5>Current Address: <b>{{employee.ADDRESS}}</b></h5>
          <b-form-group
              label="New Address:"
...
export default {
  ...
  created() {
    ...
    socket.on('updateResponse', (res)=>{
      if(res.success){
        root.$router.push('/employees/profile/dashboard').catch((e)=>{
